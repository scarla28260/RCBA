...
async function migrateAndSeed() {
  try {
    ...
    // 3. Hierarchy Override (Philippe > Pierre)
    // Philippe BARBIER (Superviseur) -> Priority 1
    // Pierre MOMPO (Principal) -> Priority 2
