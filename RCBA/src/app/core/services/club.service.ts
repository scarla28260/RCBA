...
export class ClubService {
  ...
  // 6.4 Dirigeants & Staff — Source : rcba.footeo.com/dirigeants.html (Saison 2026-2027)
  readonly staff = signal<StaffMember[]>([
    ...
    // TECHNIQUE — Entraîneurs & Éducateurs
    {
      id: 'didier-vandier',
      firstName: 'Didier',
      lastName: 'VANDIER',
    ...
    // MEMBRES DU CONSEIL D'ADMINISTRATION & ENCADREMENT (Organigramme Footeo)
    {
